...
[.text-center]
image:icons/icon-previous.png[align=left, width=128, link=lab_3.adoc] image:icons/icon-home.png[align="center",width=128, link=tech_overview.adoc] image:icons/icon-next.png[align="right"width=128, link=lab_5.adoc]
